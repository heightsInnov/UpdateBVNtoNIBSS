    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                {
                    System.out.println("This is fileUpload >> " + item.getFieldName()+ ">> "+ item.getString());
                }
            }
        ...
        try {
            ...
            System.out.println("got json NIBSS<<>>>" + obj[0].getNIBSS());
            System.out.println("got json FCUBS<<>>>" + obj[0].getFCUBS());
            System.out.println("got json Modification<<>>>" + obj[0].getModification());
            ...
            System.out.println("got NIBSS <<>>>" + obj[5].getNIBSS());
            System.out.println("got getFCUBS <<>>>" + obj[5].getFCUBS());
            System.out.println("got getModification <<>>>" + obj[5].getModification());
            System.out.println("got getFileupload <<>>>" + obj[5].getFileupload());
            System.out.println("got getComment <<>>>" + obj[5].getComment());
            
            isther = Pb.processBVNUpdateRequest(obj, bvnumber, "", username, branchcode);
