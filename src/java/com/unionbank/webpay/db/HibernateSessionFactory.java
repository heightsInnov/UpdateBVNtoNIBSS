package com.unionbank.webpay.db;
...
public class HibernateSessionFactory {
    ...
    static {
        ...
        {
            /*Encryptor encryptor =
            new Encryptor( Encryptor.KEY );
            configuration.configure(configFile);
            String pass=encryptor.decryptStringEncoded(configuration.getProperty("hibernate.connection.password"));
            configuration.setProperty("hibernate.connection.password",pass);*/
            configuration.configure(configFile);
            sessionFactory = configuration.buildSessionFactory();
        } catch (Exception e) {
            LoggingUtil.logThrowable("%%%% Error Creating SessionFactory in the HibernateSessionFactory class%%%%", e, logger);
        }
    }
