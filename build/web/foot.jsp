...
<div class="footer bg-primary" align="center">
    <footer>
        <p><strong>&copy;2016- All Rights Reserved -Union Bank of Nigeria Plc </strong></p>
...
<script>
	function myFunction(loginAttempts, oInput) {
		...
		document.getElementById("firstnamefile").value = txt;
...
<script>
	function myFunction4(loginAttempts, oInput) {
		...
		// document.getElementById("demo").innerHTML = txt;
		document.getElementById("maritalstatfile").value = txt;
		/// alert(document.getElementById("firstnamefile").value);
		//  loginAttempts.value = txt;
		//   var myparam = "abc";
...
<script>
	function myFunction8(loginAttempts, oInput) {
		...
		var x = document.getElementById("myfile88");
		var txt = "";
		if ('files' in x) {
			if (x.files.length == 0) {
				txt = "Select one or more files.";
		...
		// document.getElementById("demo").innerHTML = txt;
		document.getElementById("lgafile").value = txt;
		/// alert(document.getElementById("firstnamefile").value);
		//  loginAttempts.value = txt;
		//   var myparam = "abc";
...
<script>
	function myFunction7(loginAttempts, oInput) {
		...
		var x = document.getElementById("myfile77");
		var txt = "";
		if ('files' in x) {
			if (x.files.length == 0) {
				txt = "Select one or more files.";
...
<script>
	function myFunction9(loginAttempts, oInput) {
		...
		var x = document.getElementById("myfile99");
		var txt = "";
		if ('files' in x) {
			if (x.files.length == 0) {
				txt = "Select one or more files.";
...
<script>
	function myFunction10(loginAttempts, oInput) {
		var _validFileExtensions = [".jpg", ".jpeg", ".bmp", ".gif", ".png", ".pdf", ".zip", ".rar"];
		...
		var x = document.getElementById("myfile100");
		var txt = "";
		if ('files' in x) {
			if (x.files.length == 0) {
				txt = "Select one or more files.";
...
<script>
	function myFunction20(loginAttempts, oInput) {
		var _validFileExtensions = [".jpg", ".jpeg", ".bmp", ".gif", ".png", ".pdf", ".zip", ".rar"];
		...
		var x = document.getElementById("myfile111");
		var txt = "";
		if ('files' in x) {
			if (x.files.length == 0) {
				txt = "Select one or more files.";
		...
		// document.getElementById("demo").innerHTML = txt;
		document.getElementById("stateoforiginfile").value = txt;
		/// alert(document.getElementById("firstnamefile").value);
		//  loginAttempts.value = txt;
		//   var myparam = "abc";
...
<script>
	function myFunction21(loginAttempts, oInput) {
		var _validFileExtensions = [".jpg", ".jpeg", ".bmp", ".gif", ".png", ".pdf", ".zip", ".rar"];
		...
		var x = document.getElementById("myfile112");
		var txt = "";
		if ('files' in x) {
			if (x.files.length == 0) {
				txt = "Select one or more files.";
		...
		// document.getElementById("demo").innerHTML = txt;
		document.getElementById("sexfile").value = txt;
		/// alert(document.getElementById("firstnamefile").value);
		//  loginAttempts.value = txt;
		//   var myparam = "abc";
...
<script>
	function myFunction150(loginAttempts, oInput) {
		var _validFileExtensions = [".jpg", ".jpeg", ".bmp", ".gif", ".png", ".pdf", ".zip", ".rar"];
		...
		var x = document.getElementById("myfile150");
		var txt = "";
		if ('files' in x) {
			if (x.files.length == 0) {
				txt = "Select one or more files.";
		...
		// document.getElementById("demo").innerHTML = txt;
		document.getElementById("titlefile").value = txt;
		/// alert(document.getElementById("firstnamefile").value);
		//  loginAttempts.value = txt;
		//   var myparam = "abc";
