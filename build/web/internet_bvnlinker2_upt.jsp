                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xm-12">                                
                                        <div class="form-group">
                                            <label for="bvnfield"> Account Number </label>
                                            <input type="text" class="form-control"  name ="acctnum"   disabled value=" <%=acctnum%>" id="acctnum" maxlength="10" placeholder="Enter Account Number" required>
                                        </div>                                
                                    </div>  
                                    <div class="col-md-4 col-sm-4 col-xm-12">                                
                                        <div class="form-group">
                                            <label for="bvnfield"> Bank Verification Number </label>
                                            <input type="text" class="form-control"  name ="bvnfield"      id="acctnum" maxlength="11" placeholder="Enter Bank Verification Number" required>
                                        </div>                                
                                    </div> 
