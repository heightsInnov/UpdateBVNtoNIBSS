...
<html lang="en">
    <head>
        ...
        <title>Login UBN-BVN Portal</title>
        <style>
            p::first-letter {
                font-size: 200%;
                color: #8A2BE2;
    ...
    <body>
        ...
        <div class="container" style="max-width:400px">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" action="processor.jsp" method="post">  
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="username"  name="username" class="form-control" autocomplete="off" placeholder="Enter Your User Name" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
        ...
        <div align="center">
            <footer>
                <p>&copy;2016- All Rights Reserved -Union Bank of Nigeria Plc </p>
            </footer>
        </div>
