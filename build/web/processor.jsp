...
<%@page import="com.unionbank.core.BatchBVNExecution"%>
...
//            request.setAttribute("transactionid", txnId);
                ...
                System.out.println("The response Code ====>>> " + mert.getResponseCode());
        ...
        } else if (command.equalsIgnoreCase("pushservice")) {
            BatchBVNExecution start = new BatchBVNExecution();
            try {
                System.out.println(" =========About entering the service============ ");
                start.executeBatchBVNs();
                System.out.println(" =========Out of the service============ ");
            } catch (Exception e) {
                e.printStackTrace();
                System.out.println("*******Seems there is an error:::::: i am stuck again!!!!**********");
            }
            ...
            if (Usm.IsAuthenticate(username.trim(), loginPassword.trim(), module)) {
				//if (username.trim()!= null && loginPassword.trim() != null) {
                //  }
         ...
         response.sendRedirect("login.jsp");
            ...
            String DisplayName = "", Depts = "", branchcode = "", userEmail = "";
            try {
                //comment2
                comment2 = request.getParameter("comment2");
                ...
                System.out.println("getEmail<<>> " + ursPpee.getEmail().getValue());
            ...
            try {
                ...
                pros.approveDenieFunction(nibssid, "APPROVE", userEmail, branchcode, comment2);
            ...
            try {
                ...
                System.out.println("what is nibssid<<>>" + nibssid);
                Processor pros = new Processor();
                pros.approveDenieFunction(nibssid, "REJECT", userEmail, branchcode, comment2);
                System.out.println("Was here <>>>>>");
            } catch (Exception e) {
                e.printStackTrace();
            }
