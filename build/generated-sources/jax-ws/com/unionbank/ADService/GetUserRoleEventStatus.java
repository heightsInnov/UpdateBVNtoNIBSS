...
@XmlRootElement(name = "GetUserRoleEventStatus")
public class GetUserRoleEventStatus {
    ...
    @XmlElementRef(name = "Status", namespace = "http://applications.unionbankng.com/ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> status;
    @XmlElementRef(name = "EventId", namespace = "http://applications.unionbankng.com/ws", type = JAXBElement.class, required = false)
