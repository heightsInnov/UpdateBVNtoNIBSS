...
@XmlRootElement(name = "CreateCustomerUser")
public class CreateCustomerUser {
    ...
    @XmlElementRef(name = "SecurityQuestion", namespace = "http://applications.unionbankng.com/ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> securityQuestion;
    @XmlElementRef(name = "SecurityAnswer", namespace = "http://applications.unionbankng.com/ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> securityAnswer;
    @XmlElementRef(name = "CreatedBy", namespace = "http://applications.unionbankng.com/ws", type = JAXBElement.class, required = false)
