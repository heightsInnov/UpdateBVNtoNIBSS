...
@XmlRootElement(name = "Ad2xAuthenticate")
public class Ad2XAuthenticate {
    ...
    @XmlElementRef(name = "Password", namespace = "http://applications.unionbankng.com/ws", type = JAXBElement.class, required = false)
    protected JAXBElement<String> password;
    @XmlElementRef(name = "Token", namespace = "http://applications.unionbankng.com/ws", type = JAXBElement.class, required = false)
