                                    ...
                                    <table  id="test"  class="table table-striped table-bordered">
                                        <thead class="bg-info">
                                            <tr>     
                                                ...
                                                <th class="text-right">MAKER</th> 
                                                <th class="text-right">CHECKER</th> 
                                        ...
                                        <tbody> 
                                            ...
                                            <%
                                                /* <th class="text-right">BVNUMBER</th>
                                                 ...
                                                 <th class="text-right">DATE OF BIRTH</th>
                                                 <th class="text-right">REQUEST DATE</th>*/
                                                String bvn = "", oldfirstName = "", oldLastName = "", dateOfBirth = "",
                                                        requestDate = "", requestid = "", approveDate = "", maker = "", checker = "";
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"> <%=checker%></td>  
