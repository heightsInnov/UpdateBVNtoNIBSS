                ...
                <div class="container">
                    <div class="panel panel-default control-panel"  >
                        ...
                        <div class="panel-body" style="background-color:#FBFBFB; height:400px " >
                            <form  action="getRequestID.jsp" method="post">  
                                <input type="hidden" name="command" value="fetchRecordsReqID">
                                <div class="row">

                                    <div class="col-md-4 col-sm-4 col-xm-12">                                
                                        <div class="form-group">
                                            <label for="reqId">Enter Request ID: </label>
                                            <input type="text" class="form-control" onkeypress="validateInput('[0-9]*')" name ="reqIdT" id="reqIdT" autocomplete="off" autofocus placeholder="Enter Request ID" required>
                                        </div>                                
                                    </div>   
