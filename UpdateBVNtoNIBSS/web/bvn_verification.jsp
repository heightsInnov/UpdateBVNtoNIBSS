                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xm-12">                                
                                        <div class="form-group">
                                            <label for="cbvn">Enter Biometric Verification Number </label>
                                            <input type="text" class="form-control"  name ="cbvn" id="cbvn" placeholder="Enter Biometric Verification Number" required>
                                        </div>                                
                                    </div>   
