                            ...
                            <div class="panel-heading" style="margin-bottom:0px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xm-12">
                                        <span class="text-right"><h3 style="margin-bottom:0px;margin-top:5px">Rejected List</h3></span>
                                    </div>
                                </div>
                            </div>
                        </div>    
                                ...
                                <table  id="test"  class="table table-striped table-bordered">
                                    <thead class="bg-info">
                                        <tr>     
                                            ...
                                            <th class="text-right">REJECTION DATE</th>                                        
                                        </tr>
                                    </thead>
                                    <tfoot class="bg-info">
                                    </tfoot>
                                    <tbody> 
                                        ...
                                        <%
                                            ...
                                            try {
                                                tTransactionsList = pp.getPendingList("X");
                                            } catch (Exception e) {
                                                e.printStackTrace();
                                            }
